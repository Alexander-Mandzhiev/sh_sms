...
type AuthService interface {
	...
	RefreshToken(ctx context.Context, refreshToken string, clientID uuid.UUID, appID int) (*models.Session, error)

	ValidateToken(ctx context.Context, token string, tokenTypeHint string) (*models.TokenMetadata, error)
	IntrospectToken(ctx context.Context, token string) (*models.Session, *models.UserInfo, error)
...
func Register(gRPCServer *grpc.Server, service AuthService, logger *slog.Logger) {
