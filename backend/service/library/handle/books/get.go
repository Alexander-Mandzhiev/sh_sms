...
func (s *serverAPI) GetBook(ctx context.Context, req *library.GetBookRequest) (*library.BookResponse, error) {
	...
	logger.Debug("client ID parsed", slog.String("uuid", clientID.String()))
	...
	protoBook := book.BookResponseToProto()
