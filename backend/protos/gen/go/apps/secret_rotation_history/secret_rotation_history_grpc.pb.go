...
const (
	RotationHistoryService_GetRotation_FullMethodName   = "/apps.secrets_history.RotationHistoryService/GetRotation"
	RotationHistoryService_ListRotations_FullMethodName = "/apps.secrets_history.RotationHistoryService/ListRotations"
)
...
type RotationHistoryServiceClient interface {
	GetRotation(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*RotationHistory, error)
	ListRotations(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error)
}
...
func (c *rotationHistoryServiceClient) GetRotation(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*RotationHistory, error) {
...
func (c *rotationHistoryServiceClient) ListRotations(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type RotationHistoryServiceServer interface {
	GetRotation(context.Context, *GetRequest) (*RotationHistory, error)
	ListRotations(context.Context, *ListRequest) (*ListResponse, error)
...
func (UnimplementedRotationHistoryServiceServer) GetRotation(context.Context, *GetRequest) (*RotationHistory, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetRotation not implemented")
}
func (UnimplementedRotationHistoryServiceServer) ListRotations(context.Context, *ListRequest) (*ListResponse, error) {
...
func _RotationHistoryService_GetRotation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RotationHistoryServiceServer).GetRotation(ctx, req.(*GetRequest))
	}
...
func _RotationHistoryService_ListRotations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RotationHistoryServiceServer).ListRotations(ctx, req.(*ListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RotationHistoryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "apps.secrets_history.RotationHistoryService",
	...
	Metadata: "apps/secret_rotation_history/secret_rotation_history.proto",
}
