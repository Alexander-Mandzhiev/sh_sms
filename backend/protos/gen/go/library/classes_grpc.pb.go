...
const (
	ClassService_GetClass_FullMethodName    = "/library.ClassService/GetClass"
	ClassService_ListClasses_FullMethodName = "/library.ClassService/ListClasses"
)
...
type ClassServiceClient interface {
	...
	ListClasses(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListClassesResponse, error)
}
...
func (c *classServiceClient) ListClasses(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListClassesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ClassServiceServer interface {
	...
	ListClasses(context.Context, *emptypb.Empty) (*ListClassesResponse, error)
...
func (UnimplementedClassServiceServer) ListClasses(context.Context, *emptypb.Empty) (*ListClassesResponse, error) {
...
func _ClassService_ListClasses_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClassServiceServer).ListClasses(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ClassService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "library.ClassService",
	...
	Metadata: "library/classes.proto",
}
